...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 02, 2019 at 12:52 AM
...
(19, 'Columbia Men\'s Powderhouse Titanium Omni-Heat 3D OutDry Winter Boots', 'Columbia_Mens_Powderhouse_Titanium_Omni-Heat_3D_OutDry.png', 'The Columbia Men\'s Powderhouse Titanium Omni-Heat 3D OutDry is a feature-rich winter boot built to protect and perform in extreme conditions. Designed to withstand sub-zero temperatures, the waterproof-breathable upper, advanced thermal-reflective lining, and 600g insulation keep cold out and warmth in. Superior midsole cushioning and a high-grip Michelin® outsole combine for a comfortable, sure-footed ride in harsh weather and terrain.', '249.99', 'boot'),
(20, 'The North Face Men\'s Chilkat III Winter Boots', 'The_North_Face_Mens_Chilkat_III.png', 'Perfect for climbing in and out of tents on cold, wet days, these easy on/off boots feature a waterproof construction, ample (200 g) Heatseeker™ insulation and durable, rubber soles for excellent traction.', '149.99', 'boot'),
...
(22, 'Toronto Raptors Men\'s Nike Lin Swingman Icon Jersey', 'Toronto_Raptors_Mens_Nike.png', 'Based on the authentic NBA jersey, the Icon Edition Swingman (Toronto Raptors) Men’s Nike NBA Connected Jersey lets you rep your team while helping keep you cool and comfortable through every move.', '130.00', 'jersey'),
(23, 'Toronto Blue Jays Marcus Stroman Home Baseball Jersey', 'Toronto_Blue_Jays_Marcus_Stroman_Home', 'Enjoy the Toronto Blue Jays game in style and comfort with your new Marcus Stroman Jays home jersey.', '159.99', 'jersey'),
(24, 'Indianapolis Colts Luck Blue Football Jersey', 'Indianapolis_Colts_Luck_Blue.png', 'The NFL Indianapolis Colts Limited Jersey delivers unparalleled fit and style for fans who command attention, at the stadium and on the street.', '149.99', 'jersey'),
(25, 'Vancouver Whitecaps Men\'s 2018/19 adidas Replica Away Jersey', 'Vancouver_Whitecaps_Mens_2018_adidas.png', 'Created for fans, this jersey keeps you comfortable as you roar Vancouver Whitecaps FC to victory on the road. Made of soft fabric that channels moisture away from your skin, it has a slightly looser fit than the shirts the club’s players wear on the pitch. A woven team badge stands out on the chest. Stay dry Climalite wicks sweat to keep you dry in every condition Made for fans A fan jersey is a streetwear version of what players wear on match day and is wider in the shoulders and body.', '109.99', 'jersey'),
(26, 'Fitbit Versa Lite Smart Watch - White', 'Fitbit_Versa_Lite_Smart_Watch.png', 'Open a world of possibilities with Fitbit Versa™ Lite Edition, the versatile, everyday smartwatch. With all the core fitness and smart features, vibrant colors and an easy one-button design, this watch will inspire you to live boldly and make your goals reality.', '199.95', 'electronics'),
(27, 'GoPro HERO7 White Edition Action Camera', 'GoPro_HERO7_White_Edition_Action_Camera.png', 'Say hello to New GoPro HERO 7 White, the perfect partner on any adventure. It’s tough, tiny and totally waterproof so it can go wherever you do. An intuitive touch screen makes it simple to get great shots. Just swipe and tap. Use the photo timer to grab a sweet selfie. You can even shoot vertically then add your photos and videos right to your Instagram Story. Your shots move to the GoPro app automatically to share on the spot. From awesome moments to everyday experiences, capture the fun in creative new ways with GoPro HERO 7 White edition.', '269.99', 'electronics'),
(28, 'Apple Watch Series 4 GPS, 44mm Space Grey Aluminum Case with Black Sport Band', 'Apple_Watch_Series_4_GPS_44mm_Space_Grey.png', 'The New Apple Watch Series 4 is here! Fundamentally redesigned and re-engineered. The largest Apple Watch display yet. Built-in electrical heart sensor. New Digital Crown with haptic feedback. Low and high heart rate notifications. Fall detection and Emergency SOS. New Breathe watch faces. Automatic workout detection. New yoga and hiking workouts. Advanced features for runners like cadence and pace alerts. New head-to-head competitions. Activity sharing with friends. Personalized coaching. Monthly challenges and achievement awards. You can use Walkie-Talkie and send messages. Listen to Apple Music1 and Apple Podcasts. And use Siri in all-new ways. Apple Watch Series 4 lets you do it all right from your wrist.', '559.00', 'electronics'),
(29, 'Beats Solo2 On-Ear Headphones – Luxe Edition, Red', 'Beats_Solo2_On-Ear_Headphones_Luxe_Edition_Red.png', 'The sound and design you’ve come to expect from our Beats Solo2 is now matched by a refined glossy finish and polished accents.', '219.99', 'electronics'),
(30, 'Garmin Fenix 5 GPS Watch - Slate Grey with Black Band', 'Garmin_Fenix_5_GPS_Watch_Slate_Grey.png', 'Beat yesterday all day, every day. fenix 5 is the premium multisport GPS watch with wrist-based heart rate, advanced fitness features and interchangeable bands that let you go from workplace to workout without breaking stride. Whatever sport you want to track, fenix 5 has it covered, thanks to built-in activity profiles and performance metrics plus smart notifications.', '519.99', 'electronics'),
(31, 'Helly Hansen Women\'s Verket Reversible Pile Jacket - Ebony', 'Helly_Hansen_Womens_Verket_Reversible_Pile_Jacket.png', 'This reversible pile will give you versatility in whatever you choose to do, perfect for both urban and outdoor activities.', '179.99', 'hoodie'),
(32, 'adidas Originals Women\'s Trefoil Pullover Hoodie', 'adidas_Originals_Womens_Trefoil_Pullover_Hoodie.png', 'This hoodie celebrates Valentine’s Day with bold red color. It’s made of cotton French terry with a soft, comfortable feel. The sweatshirt is finished with an iconic Trefoil logo on the front.', '89.99', 'hoodie'),
(33, 'Nike Sportswear Women\'s Heritage Pullover Hoodie', 'Nike_Sportswear_Womens_Heritage_Pullover_Hoodie.png', 'Make it memorable in the Nike Sportswear Women’s Fleece Hoodie, a timeless look made with soft, semi-brushed fleece fabric. A Chevron design throws it back to Windrunner style, while ribbed details add a classic feel.', '80.00', 'hoodie'),
(34, 'PUMA Women\'s Modern Sports Crop Hoodie', 'PUMA_Womens_Modern_Sports_Crop_Hoodie.png', 'The PUMA Modern Sports Cropped Hoodie is the best of both worlds. Made with a modern cropped design and featuring classic elements of sportswear, this comfortable hoodie is perfect to pair with all your other essentials.', '64.99', 'hoodie'),
(35, 'Under Armour Women\'s Fleece Logo Pullover Hoodie', 'Under_Armour_Womens_Fleece_Logo_Pullover_Hoodie.png', 'Armour Fleece® is UA’s original performance replacement for old-school fleece. It’s light, incredibly warm, and has just the right amount of stretch.', '51.97', 'hoodie');
COMMIT;
